...
setlocale(LC_ALL, "es_ES"); //idioma de los date() en espa�ol
ini_set('default_charset', 'utf-8');

/*
//Creamos variable de sesi�n con el lenguaje
...
if(isset($_REQUEST['lang'])){
	...
	if(!in_array($_SESSION['lang'], $lenguas_permitidas) || $_SESSION['lang']=='es'){
		$_SESSION['lang'] = ''; //si no es un lenguaje permitido o si es espa�ol, lo dejamos a vacio
	}	
}else{
