...
$(function(){
	...
	var options = {
		...
		twitter: {
			text: 'Echale un vistazo a esta noticia que he visto '
		},
		facebook: {
			text: 'Echale un vistazo a esta noticia que he visto '
		},
	...
	var texto=$(this).text();
	$('.socialShare').shareButtons(url, options, texto );
	//$('.socialShare').shareButtons(url, options);
});

(function ($) {

	$.fn.shareButtons = function (url, options, texto) {
		...
		var shareURLs = {
			...
			'whatsApp': 'https://wa.me/whatsappphonenumber/?text=' + url_encoded
		};
		...
		this.each(function(i){
			...
			if(options.whatsApp) {
				socialButtonsPopUp.append($('<a class="fa fa-whatsapp custom" href="'+ shareURLs.whatsApp + '" ></a>'));
			}
		});
